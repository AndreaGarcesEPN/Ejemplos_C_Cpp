...
int main()
{
	...
	/*Cliente cliente_6;
	cout << "Nombre: ";
	cin.getline(cliente_6.nombre, 20);
	cout << "Unidades: ";
	cin >> cliente_6.numUnidades;
	cout << "Precio: ";
	cin >> cliente_6.precio;
	cout << "Estado: ";
	cin >> cliente_6.estado;
	
	cout << "Los valores del cliente 6 son: " << cliente_6.nombre << ", " 
	<< cliente_6.numUnidades << ", " << cliente_6.precio << ", " 
	<< cliente_6.estado << endl;*/
	
	Cliente *cliente_7 = new Cliente;
	cout << "Nombre: ";
	cin.getline(cliente_7->nombre, 20);
	cout << "Unidades: ";
	cin >> cliente_7->numUnidades;
	cout << "Precio: ";
	cin >> cliente_7->precio;
	cout << "Estado: ";
	cin >> cliente_7->estado;
	
	cout << "Los valores del cliente 7 son: " << cliente_7->nombre << ", " 
	<< cliente_7->numUnidades << ", " << cliente_7->precio << ", " 
	<< cliente_7->estado << endl;
